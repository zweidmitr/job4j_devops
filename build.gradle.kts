...
// 1. Define a new source set for integration tests
...
// 2. Create new configurations for the integration tests
...
// 3. Create a dedicated task to run integration tests
...
// 4. Make `check` depend on `integrationTest`
tasks.check {
